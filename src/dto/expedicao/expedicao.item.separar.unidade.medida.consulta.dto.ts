export default class ExpedicaoItemSepararUnidadeMedidaConsultaDto {
  CodEmpresa: number;
  ...
  public copyWith(params: {
    ...
    return new ExpedicaoItemSepararUnidadeMedidaConsultaDto({
  ...
  static fromObject(object: any): ExpedicaoItemSepararUnidadeMedidaConsultaDto {
    return new ExpedicaoItemSepararUnidadeMedidaConsultaDto({
